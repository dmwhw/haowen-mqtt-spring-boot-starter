...
public class MyMqttAutoConfigurer {
    ...
    public MyMQTTClient myMQTTClient() {
        ...
        List<MqttConnectlLostListener> _mqttConnectlLostListeners =
            Filter.filterAndSort(mqttConnectlLostListeners, myMQTTClient);
        List<MqttDeliveryCompleteListener> _mqttDeliveryCompleteListeners =
            Filter.filterAndSort(mqttDeliveryCompleteListeners, myMQTTClient);
        List<MqttMsgArrivedListener> _mqttMsgArrivedListeners =
            Filter.filterAndSort(mqttMsgArrivedListeners, myMQTTClient);
        return MyMqttInitializer.init(mqttConfig, _mqttListeners, _mqttConnectlLostListeners,
            _mqttDeliveryCompleteListeners, _mqttMsgArrivedListeners);
    }
